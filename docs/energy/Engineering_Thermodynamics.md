...
通常情况下制冷循环是以环境作为高温热源($T_1 = T_{Ⅰ}$)，冷库温度为$T_2=T_{Ⅱ}$，易得逆卡诺循环的制冷系数：
...
循环所耗的净功： $w_net = q_2 - q_1 = c_p(T_2 - T_3) - c_p(T_1 - T_4)$

则空气压缩循环的制冷系数：

\[
	\begin{aligned}
	\epsilon =& \frac{q_1}{w_net} = \frac{T_1 - T_4}{(T_2 - T_3) - (T_1 - T_4)} \\
